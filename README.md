...
📊 Project Overview
This project presents a comprehensive analysis of road and bridge development across India using Microsoft Excel as the primary platform for data processing and visualization. The dataset is sourced from the official data.gov.in portal and captures infrastructure progress under PMGSY-I, PMGSY-II, PMGSY-III, RCPLWEA, and PM-JANMAN schemes.
...
Column, Donut, Line, and Area Charts

Slicers for interactivity

Map Chart for geospatial insights

📈 Completion % calculated for more effective comparisons

🔍 Identifies top-performing and underperforming states and schemes
...
Andaman and Nicobar Islands show significant lags in both road and bridge projects.
